<?php
namespace CostBase\Collector;

use Laminas\Mvc\MvcEvent;
use Laminas\Db\Adapter\Profiler\Profiler;
use LaminasDeveloperTools\Collector\CollectorInterface;
class DbCollector implements \LaminasDeveloperTools\Collector\CollectorInterface
{
    protected $profilers = array();

    public function getName() {
        return 'CostBaseDbProfiler';
    }
